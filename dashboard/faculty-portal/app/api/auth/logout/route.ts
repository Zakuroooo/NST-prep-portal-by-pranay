/**
 * dashboard/faculty-portal/app/api/auth/logout/route.ts
 * POST /api/auth/logout — clears the JWT cookie from faculty portal.
 */
...
export async function POST(): Promise<NextResponse> {
  ...
  response.cookies.set(`${TOKEN_COOKIE_NAME}_faculty`, '', cookieOptions);
